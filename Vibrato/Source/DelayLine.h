...
public:
    ...
    double delayLine_Vibrato_R(double input, double samples);
    
    double delayLine_Vibrato_Ref_L(double x, double samples);
    double delayLine_Vibrato_Ref_R(double x, double samples);
