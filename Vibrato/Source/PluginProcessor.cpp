...
void VirtualTubeVibratoAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
    ...
    for (int i = 0; i < numSamples; ++i)
    {
        ...
        double currentDelayL = interpolatedMaxDelaySamples_L/2 * ((1 + sin(2.0 * M_PI * ph) * width));
        double currentDelayR = interpolatedMaxDelaySamples_R/2 * ((1 + sin(2.0 * M_PI * ph) * width));
        
        double currentDelayRefL = interpolatedMaxDelaySamplesRef_L/2 * ((1 + sin(2.0 * M_PI * ph) * width));
        double currentDelayRefR = interpolatedMaxDelaySamplesRef_R/2 * ((1 + sin(2.0 * M_PI * ph) * width));
...
void VirtualTubeVibratoAudioProcessor::applyFilterDelay_L(int numSamples){
...
void VirtualTubeVibratoAudioProcessor::applyFilterDelay_R(int numSamples){
...
void VirtualTubeVibratoAudioProcessor::applyGain(int numSamples){
...
void VirtualTubeVibratoAudioProcessor::process() {
...
double VirtualTubeVibratoAudioProcessor::computeOutFilter_L(double input){
...
double VirtualTubeVibratoAudioProcessor::computeOutFilter_R(double input){
...
double VirtualTubeVibratoAudioProcessor::computeOutReflectionFilter_L(double input){
...
double VirtualTubeVibratoAudioProcessor::computeOutReflectionFilter_R(double input){
