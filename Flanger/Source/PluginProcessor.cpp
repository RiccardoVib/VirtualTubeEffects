...
#endif
{
    ...
    parameters.createAndAddParameter("frequencyRate_", "frequencyRate", "frequencyRate", NormalisableRange<float>(0.1f, 10.0f), 0.1f, nullptr, nullptr);
...
void VirtualTubeFlangerAudioProcessor::process(int channel) {
...
double VirtualTubeFlangerAudioProcessor::computeOutFilter(double input, int channel){
...
double VirtualTubeFlangerAudioProcessor::computeOutReflectionFilter(double input, int rad, int channel){
...
void VirtualTubeFlangerAudioProcessor::applyFilterDelay(int numSamples, int channel){
...
void VirtualTubeFlangerAudioProcessor::applyGainAndWidth(int numSamples){
