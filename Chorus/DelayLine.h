...
public:
    ...
    double delayLine_Chorus_L(double input, double samples);
    double delayLine_Chorus_R(double input, double samples);
    
    double delayLine_Chorus_Ref_L(double x, double samples);
    double delayLine_Chorus_Ref_R(double x, double samples);
