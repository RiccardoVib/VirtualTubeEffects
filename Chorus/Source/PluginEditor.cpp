    ...
    delayTimeLeftLabel_("", "Left Channel:"), delayTimeRightLabel_("", "Right Channel:"), gainLeftLabel_("", "Left Channel:"), gainRightLabel_("", "Right Channel:"), tubeSizeLabel_("", "Tube Size (cm):"), dryWetMixLabel_("", "Dry/Wet:"), delayTimeRefLeftLabel_("", "Left Channel:"),delayTimeRefRightLabel_("", "Right Channel:"), gainRefLeftLabel_("", "Left Channel:"),gainRefRightLabel_("", "Right Channel:"), frequencyRateLabel_("", "Frequency Rate:"), widthLabel_("", "Width:"), feedbackLabel_("", "Feedback:")
{
    ...
    delayTimeLeftSlider_.setRange (20.0f, 30.0f, 0.01f);
    ...
    delayTimeLeftSlider_.setDoubleClickReturnValue(true, 20.0f);
    ...
    delayTimeRightSlider_.setRange (20.0f, 30.0f, 0.01f);
    ...
    delayTimeRightSlider_.setDoubleClickReturnValue(true, 20.0f);
    ...
    delayTimeRefLeftSlider_.setRange (20.0f, 30.0f, 0.01f);
    ...
    delayTimeRefLeftSlider_.setDoubleClickReturnValue(true, 20.0f);
    ...
    delayTimeRefRightSlider_.setRange (20.0f, 30.0f, 0.01f);
    ...
    delayTimeRefRightSlider_.setDoubleClickReturnValue(true, 20.0f);
    ...
    frequencyRateSlider_.setRange (0.1f, 0.3f, 0.01f);
